        ...
        <div class="space-y-28">
            ...
            <div x-data="{ open: false }">
                <div class="grid md:grid-cols-2 gap-12 items-center">
                    ...
                    <div>
                        <span @click="open = ! open" class="text-sm font-semibold text-green-700 uppercase tracking-wide">Agro-Stalex</span>
            ...
            <div 
                ...
                <div class="grid md:grid-cols-2 gap-12 items-center">
                    ...
                    <div>
                        <span @click="open = ! open" class="text-sm font-semibold text-purple-700 uppercase tracking-wide">Aktywnie dla siebie</span>
            ...
            <div x-data="{ open: false }">
                <div class="grid md:grid-cols-2 gap-12 items-center md:flex-row-reverse">
                    ...
                    <div class="order-2 md:order-1">
                        <span @click="open = ! open"  class="text-sm font-semibold text-orange-600 uppercase tracking-wide">Alpakraina</span>
